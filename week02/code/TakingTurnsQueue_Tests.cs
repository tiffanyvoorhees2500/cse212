...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Wasn't checking if the person had turns remaining before adding them back to the queue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: not checking if person.Turns is less than or equal to 0 before adding them back to the queue.
